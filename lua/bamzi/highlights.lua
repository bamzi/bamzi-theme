local highlights = {
  ...
  NonText = { fg = C.bg },
  Variable = { fg = C.white },
  String = { fg = C.alt_green },
  Character = { fg = C.green },
  Constant = { fg = C.orange },
  Number = { fg = C.magenta },
  Boolean = { fg = C.alt_cyan },
  Float = { fg = C.alt_cyan },
  ...
  Structure = { fg = C.alt_cyan },
  Typedef = { fg = C.pale_purple },
  Keyword = { fg = C.cyan },
  Statement = { fg = C.cyan_test },
  Conditional = { fg = C.alt_green },
  Repeat = { fg = C.orange },
  Label = { fg = C.yellow },
  Exception = { fg = C.blue },
  Include = { fg = C.blue },
  ...
  Todo = { fg = C.tester, bg = C.bg, style = "bold" },
  ...
  CmpDocumentationBorder = { fg = C.alt_bg, bg = C.none },
  ...
  CmpItemMenu = { fg = C.light_green, bg = C.none },
}

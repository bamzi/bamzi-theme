...
theme.set_highlights = function()
	...
	hl(0, "NvimSeparator", { fg = c.dark_gray, bg = c.bg })
	hl(0, "WinSeparator", { fg = c.dark_gray, bg = c.bg })
	...
	hl(0, "Variable", { fg = c.ui4, bg = "NONE" })
	hl(0, "String", { fg = c.ui8, bg = "NONE" })
	hl(0, "Character", { fg = c.orange, bg = "NONE" })
	hl(0, "Number", { fg = c.ui10, bg = "NONE" })
	hl(0, "Float", { fg = c.ui10, bg = "NONE" })
	hl(0, "Boolean", { fg = c.cyan, bg = "NONE" })
	hl(0, "Constant", { fg = c.red, bg = "NONE" })
	hl(0, "Type", { fg = c.yellow_orange, bg = "NONE" })
	hl(0, "Function", { fg = c.yellow, bg = "NONE" })
	hl(0, "Method", { fg = c.yellow, bg = "NONE" })
	hl(0, "Keyword", { fg = c.light_gray, bg = "NONE" })
	hl(0, "Conditional", { fg = c.red, bg = "NONE" })
	hl(0, "Repeat", { fg = c.purple, bg = "NONE" })
	hl(0, "Operator", { fg = c.ui9, bg = "NONE" })
	...
	hl(0, "Label", { fg = c.ui8, bg = "NONE" })
	hl(0, "SpecialChar", { fg = c.purple, bg = "NONE" })
	hl(0, "Delimiter", { fg = c.blue, bg = "NONE" })
	hl(0, "SpecialComment", { fg = c.ui5, bg = "NONE" })
	hl(0, "Tag", { fg = c.ui9, bg = "NONE" })
	hl(0, "Bold", { fg = "NONE", bg = "NONE", bold = true })
	hl(0, "Italic", { fg = "NONE", bg = "NONE", italic = true })
	hl(0, "Underlined", { fg = "NONE", bg = "NONE", underline = true })
	hl(0, "Ignore", { fg = c.warn, bg = "NONE", bold = true })
	hl(0, "Todo", { fg = c.sign_change_alt, bg = "NONE", bold = true })
	...
	hl(0, "TSKeywordFunction", { fg = c.context, bg = "NONE" })
	...
	hl(0, "TSTypeBuiltin", { fg = c.fg, bg = "NONE" })
	...
	hl(0, "TelescopeBorder", { fg = c.alt_fg, bg = c.ui2 })
	hl(0, "TelescopeNormal", { fg = c.fg, bg = c.ui2 })
	...
	hl(0, "NvimTreeNormal", { fg = c.fg, bg = c.ui2 })
	...
	-- DiffView
	hl(0, "DiffViewNormal", { fg = c.gray, bg = c.ui2 })
	...
	-- Neotree
	hl(0, "NeoTreeTitleBar", { fg = c.orange, bg = "NONE" })
